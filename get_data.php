...
echo "<tr>
<th class='table-info' scope='col'>customer_id</th>
<th  class='table-secondary' scope='col'>Name</th>
<th  class='table-success' scope='col'>Surname</th>
<th  class='table-danger' scope='col'>tell</th>
<th  class='table-warning'scope='col'>adress</th>
<th  class='table-primary'scope='col'>username</th>
</tr>";
...
while($gelen=mysqli_fetch_array($cevap))
{
    ...
    echo "<tr><td class='table-info'  scope='row' >".$gelen['customer_id']."</td>";
    echo "<td class='table-secondary' scope='row' >".$gelen['names']."</td>";
    echo "<td class='table-success scope='row' >".$gelen['surname']."</td>";
    echo "<td class='table-danger' scope='row' >".$gelen['tell']."</td>";
    echo "<td class='table-warning' scope='row' >".$gelen['adress']."</td>";
    echo "<td class='table-primary' scope='row' >".$gelen['username']."</td></tr>";    
